...
var edit_mode = '1', // 再編輯模式 ( '1'=開; '0'=不開 )
		...
		txt3 = '"><img src="' + pic_ys + '" style="vertical-align:middle;" alt=""/> Successfully submitted.',
		edt1 = ' Befor refreshing, You can <a rel="nofollow" class="comment-reply-link" href="#edit" onclick=\'return addComment.moveForm("',
		edt2 = ')\'>Edit your comment.</a>',
...
$('#commentform').submit(function() {
		$('#loading').slideDown();
		$submit.attr('disabled', true).fadeTo('slow', 0);
